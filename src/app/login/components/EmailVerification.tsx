...
export function EmailVerification({ email, onVerify, onResend, onBack, isLoading }: EmailVerificationProps) {
    ...
    return (
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="text-center space-y-2 mb-8">
                ...
                <h2 className="text-2xl font-bold tracking-tight text-black">Email Verification</h2>
                <p className="text-zinc-500 text-sm">
                    We've sent a 6-digit code to <span className="text-black font-semibold">{email}</span>
                </p>
            </div>
